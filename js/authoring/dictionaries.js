...
var contextInfoDictionary = {
    ...
    "CI_AUDIO_OUTPUT_AVAILABLE": "Ton verf�gbar",
    "CI_CURRENT_AIR_PRESSURE": "Aktueller Luftdruck",
    "CI_CURRENT_AMBIENT_NOISE": "Aktuelle Umgebungsger�usche",
    "CI_CURRENT_APPOINTMENT": "Aktueller Termin",
    "CI_CURRENT_HUMIDITY": "Aktuelle Luftfeuchtigkeit",
    "CI_CURRENT_LUMINOSITY": "Aktuelle Lichtst�rke",
    ...
    "CI_DEVICE_TYPE": "Ger�tetyp",
    "CI_DISPLAY_RESOLUTION": "Displayaufl�sung",
    "CI_EXPECTED_TIME_NEEDED_FOR_COMPLETION": "Erwartete ben�tigte Restzeit",
    "CI_EXTERNAL_DISPLAY_AVAILABLE": "Externer Bildschirm verf�gbar",
    "CI_HAS_SCREEN_READER_FUNCTIONALITY": "Hat Screenreader Funktionalit�t",
    ...
    "CI_USER_CURRENT_LEARNING_STYLE_UNDERSTANDING": "Momentaner Benutzerstilverst�ndnis",
    ...
    "CI_USER_LOCATION_BUILDING": "Geb�ude am Standort",
    ...
    "CI_USER_LOCATION_LONGITUDE": "Standort L�ngengrad",
...
var contextValueDictionary = {
    ...
    "TEACHER" : "Lehrer",
    "UNKNOWN" : "Unbekannt",
    "TRANSPORTATION" : "Auto/�ffentliche Verkehrsmittel"
};

var contextParameterValueDictionary = {
    "BAR" : "Bar",
    "MILLIMETER_OF_MERCURY" : "Millimeter in Quecksilbers�ule",
    "PASCAL" : "Pascal",
    "TORR" : "Torr",
    "DATE" : "Datum",
    "LOCATION" : "Ort",
